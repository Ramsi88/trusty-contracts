...
async function main() {
    ...
    const deployedTrustyContract = await ethers.deployContract("Recovery", [owners, confirmations, name], {
    ...
    console.log("Trusty Recovery Contract Address:", await deployedTrustyContract.getAddress());
}
