...
async function main() {
    ...
    const deployedFactoryContract = await ethers.deployContract("TrustyFactoryAdvanced", [], {
    ...
    console.log("Factory Advanced Contract Address:", await deployedFactoryContract.getAddress());
}
